...
public class Waiter {
    ...
    /**
     * Method that opens an url and waits for page load complete and for a specified WebElement to be displayed.
    ...
    /**
     * Click on a WebElement and then wait for a specified URL to load in the browser.
     * Wait for TIMEOUT number of seconds.
     *
    ...
    /**
     * Click on a WebElement and then wait for the URL that loads in the browser to contain a specified String.
     * Wait for the TIMEOUT number of seconds.
     *
     * @param element             - the WebElement to click on
    ...
    /**
     * Click on a WebElement and then wait for a specified URL to load in the browser, ignoring the case.
     * Wait for TIMEOUT number of seconds.
     *
     * @param element - the WebElement to click on
     * @param url     - the URL you need are waiting to load
